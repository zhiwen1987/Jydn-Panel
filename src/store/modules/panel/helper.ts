...
export function defaultStatePanelConfig(): Panel.panelConfig {
  return {
    ...
    poweredByUrl: 'https://github.com/liandu2024/Jydn-Panel',
    poweredByHtml: 'Powered By <a class="login-powered-link" href="https://github.com/liandu2024/Jydn-Panel" target="_blank" rel="noopener noreferrer">Jydn-Panel</a>',
    topHeaderShow: false,
